...
import { useMyProfileQuery } from "@/Hooks/Common/accountHooks";
...
export function MyProfilePage() {
  ...
  // Edit profile opens the User screen's own edit form at /users?edit=<id>.
  // Turn this on once that screen exists in this project:
  //   const canEdit = useMenuPermission("User")("Edit");
  const canEdit = false;
