...
import { DRAFT_STATUS_CODE } from "@/Utils/Constant";

// DRAFT_STATUS_CODE is env-overridable (defaults to 9) rather
...
export const statusBucket = (row) => {
  ...
  if (status.includes("draft") || process.includes("draft") || Number(row?.status) === DRAFT_STATUS_CODE) return "draft";
